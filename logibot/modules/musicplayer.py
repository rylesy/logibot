...
__HELP__ = """
 ...
 Sukuna plays plays music in your group's voice chat
...
*) If userbot joined enjoy music, If not add @RyleReal to your group and retry
<b> Commands </b>
=>> Song Playing 🎧 
...
=>> More tools 🧑‍🔧
  ...
  /userbotjoin: Invite @RyleReal Userbot to your chat
